...
class amp_base_instagram_embed_handler extends amp_base_base_embed_handler {
	...
	public function render( $args ) {
		...
		if ( empty( $args['instagram_id'] ) ) {
			return amp_base_html_utils::build_tag( 'a', array( 'href' => esc_url( $args['url'] ), 'class' => 'amp-wp-embed-fallback' ), esc_html( $args['url'] ) );
		}
