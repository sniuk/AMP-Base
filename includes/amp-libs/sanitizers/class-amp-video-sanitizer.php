 ...
 */
class amp_base_video_sanitizer extends amp_base_base_sanitizer {
	...
	public function sanitize() {
		...
		for ( $i = $num_nodes - 1; $i >= 0; $i-- ) {
			...
			$new_node = amp_base_dom_utils::create_node( $this->dom, 'amp-video', $new_attributes );
			...
			foreach ( $node->childNodes as $child_node ) {
				...
				$old_child_attributes = amp_base_dom_utils::get_node_attributes_as_assoc_array( $new_child_node );
