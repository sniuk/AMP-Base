 ...
 */
class amp_base_img_sanitizer extends amp_base_base_sanitizer {
	...
	public function sanitize() {
		...
		for ( $i = $num_nodes - 1; $i >= 0; $i-- ) {
			...
			if ( ! isset( $new_attributes['width'] ) || ! isset( $new_attributes['height'] ) ) {
				$dimensions = amp_base_image_dimension_extractor::extract( $new_attributes['src'] );
			...
			$new_node = amp_base_dom_utils::create_node( $this->dom, $new_tag, $new_attributes );
